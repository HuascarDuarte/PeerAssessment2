...
### Adjusting Damages for the Magnitude Suffixes
  ...
  We need than to take a closer look at those suffixes.
...
```
  ...
  In order to compute the damage values correctly, we will create two new columns in the EconomicImpact dataset with a numeric value corresponding to the suffixes of PROPDMGEXP and CROPDMGEXP, in order to bring all damage values to the thousands of dollars unit, as follows:
